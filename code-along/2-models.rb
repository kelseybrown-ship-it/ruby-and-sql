...
apple = Company.where({ "name" => "Apple"})[0] #if we want to return the first item in the array
puts apple.inspect
...
#eg if you want to read apple's URL

puts apple["url"]

# 6. update a row's column value
# if we want to add a URL to amazon 
...
google.destroy 
#do not need to save after destroying. destroy has save built in.
puts "There are #{Company.all.count} companies"